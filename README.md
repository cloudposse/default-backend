...
# default-backend [![Build Status](https://travis-ci.org/cloudposse/default-backend.svg?branch=master)](https://travis-ci.org/cloudposse/default-backend) [![Latest Release](https://img.shields.io/github/release/cloudposse/default-backend.svg)](https://travis-ci.org/cloudposse/default-backend/releases) [![Slack Community](https://slack.cloudposse.com/badge.svg)](https://slack.cloudposse.com)
